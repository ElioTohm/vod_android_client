...
import xms.com.vodmobile.ClipsListActivity;
...
public class ClipsGenreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new ClipsGenreActivity.GridSpacingItemDecoration(1, dpToPx(2), false));
    ...
    private void prepareGenreData() throws JSONException {
        ...
        final JSONArray bodyrequest = new JSONArray("[{\"Type\":\"Clips\"}]");
    ...
    private void gotoClipsList (Genre genre)
    {
